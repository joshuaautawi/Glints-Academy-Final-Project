...
async function login (req,res){
    ...
    try{
        ...
        const result = {
            ...
            phone : user.phone,birthday : user.birthday,roles : user.roles,
...
module.exports = { login , createUser,getUserProfile , uploadPicture,loginWithGoogleOAuth , updateUserProfile,loginWithFacebook}
