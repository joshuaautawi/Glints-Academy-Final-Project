    ...
    if(order.order_type == "RoundTrip"){
        ...
        result = {
            ...
            order_status : order.order_type, 
                destination : ""+ order.OrderDetails[0].BusSchedule.departure_city+"-"+order.OrderDetails[0].BusSchedule.destination_city,
            price_detail : {
                bus_name_one : order.OrderDetails[0].BusSchedule.Bus.bus_name ,
                bus_provider_one: order.OrderDetails[0].BusSchedule.BusProvider.provider_name,
                price_one: priceOne,
                bus_name_two : order.OrderDetails[1].BusSchedule.Bus.bus_name ,
                bus_provider_two: order.OrderDetails[1].BusSchedule.BusProvider.provider_name,
                price_two: priceTwo,
